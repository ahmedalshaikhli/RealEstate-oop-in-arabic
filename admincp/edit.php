      ...
      <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <?php
            ...
            if($_SERVER['REQUEST_METHOD'] == "POST" and isset($_POST['editPost'])){
                ...
                $post->setPostValue($_POST['title'], $_POST['link'],$_POST['desc'], $image, $_POST['category'] , "edit" , $_POST['id']);
                $post->DisplayError();
            }
          ?>
      </div>
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
      <h1 class="page-header"><i class="glyphicon glyphicon-play"></i> تعديل الفيديو</h1>
      <div class="col-md-12">
          <div class="row">
            <div class="col-md-10">
            <?php if($_SERVER['REQUEST_METHOD'] == "GET" and isset($_GET['id'])): ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-7">
                    <input type="text" class="form-control" name="title" value="<?php echo $post[0]['title'];?>" id="title" placeholder="ادخل عنوان للفيديو">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-7">
                    <input type="text" class="form-control" value="<?php echo $post[0]['video'];?>" name="link" id="link" placeholder="ادخل رابط فيديو اليوتيوب كاملاً">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                    <textarea rows="4" class="form-control" name="desc" id="desc" placeholder="ادخل وصف بسيط عن الفيديو"><?php echo $post[0]['desc'];?></textarea>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-6">
                    ...
                    <button type="submit" name="editPost" class="btn btn-block btn-warning">تعديل الفيديو</button>
                </div>
              </div>
            </form>

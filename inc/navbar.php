  ...
  <div class="container">
    ...
    <div class="navbar-header">
      <button type="button" class="navbar-toggle collapsed pull-right" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
        ...
        <a class="navbar-brand pull-left" href="."><img style="margin-top: 5px;"src="libs/image/logo2.png" width="160"/></a>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
          <li><a href="."><i class=""></i> الرئيسية <span class="sr-only">(current)</span></a></li>
        <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class=""></i> أقسام الموقع <span class="caret"></span></a>
		  ...
		  <li><a href="about.php"><i class=""></i> من نحن <span class="sr-only">(current)</span></a></li>
		  <li><a href="#call-us-section"><i class=""></i> اتصل بنا <span class="sr-only">(current)</span></a></li>
      </ul>
      <ul class="nav navbar-nav navbar-left">
          <?php if(isset($_SESSION['is_logged']) and $_SESSION['is_logged'] == true): ?>
          <li style="margin-top: 14px; padding: 0px 15px;  color: #fff;"><span>أهلا وسهلا بكـ يا <?php echo $_SESSION['user']['fname'].' '. $_SESSION['user']['lname']; ?> </span></li>
          <li class="dropdown">
